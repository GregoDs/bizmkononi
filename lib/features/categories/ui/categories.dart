                        ...
                        builder: (context, state) {
                          if (state is CategoriesLoaded) {
                            return AppText.medium(
                              'Found (${state.data.length}) Categories',
                              color: ColorName.whiteColor,
                            );
                          }
                          return Container();
                ...
                Positioned(
                  ...
                  child: SizedBox(
                    ...
                    child: TextFormField(
                      ...
                      onChanged: (value) =>
                          categoryCubit.getCategories(search: value),
                ...
                return state.data.isEmpty
                    ? Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            Image(
                              image: AssetImage(Assets.images.emptyData.path),
                            ),
                            SizedBox(
                              height: 100.h,
                            ),
                    ...
                    : SingleChildScrollView(
                        child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              String holder =
                                  item.name.toString().toUpperCase()[0];
      ...
      floatingActionButton: _focus.hasFocus
          ...
          : SizedBox(
              ...
              child: CustomButton(
                onTap: () async {
                  final result =
                      await Navigator.pushNamed(context, Routes.addCategory);
                  if (result != null && result == true) {
                    categoryCubit.getCategories();
                  }
                },
