...
class _AddIncomeState extends State<AddIncome> {
  ...
  final titleKey = 'incomeTitle';
  final amountKey = 'incomeAmount';
  final dateKey = 'incomeDate';
  final descrKey = 'incomeDescr';

  addIncome(bool isEdit) async {
    ...
    dateCubit.resetDate();
    isEdit
        ? incomeCubit.editIncome(widget.data!.id!, data)
        : incomeCubit.addIncome(data);
  }

  setDatafields() async {
    // await incomeCubit.getIncome();
    dateCubit.resetDate();
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          title: AppText.medium(
            widget.data == null ? 'Add Income' : 'Edit Income',
          ),
        ),
        body: SafeArea(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText:
                                  "Write a summary and any detail about your Income",
                              hintStyle: TextStyle(
            ...
            return Container(
              ...
              child: CustomButton(
                onTap: isFormValid
                    ? widget.data == null
                        ? () async {
                            await addIncome(false);
                          }
                        : () async {
                            await addIncome(true);
                          }
                    : () {},
                text: 'Submit',
                color:
